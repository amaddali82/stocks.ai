...
def get_fallback_india_companies() -> List[Dict]:
    """Fallback list of major Indian companies (with .NS suffix for yfinance)"""
    companies_list = [
        {'symbol': 'RELIANCE.NS', 'company': 'Reliance Industries Ltd', 'sector': 'Energy', 'industry': 'Oil & Gas'},
        {'symbol': 'TCS.NS', 'company': 'Tata Consultancy Services Ltd', 'sector': 'IT', 'industry': 'IT Services'},
        {'symbol': 'HDFCBANK.NS', 'company': 'HDFC Bank Ltd', 'sector': 'Financial', 'industry': 'Banking'},
        {'symbol': 'INFY.NS', 'company': 'Infosys Ltd', 'sector': 'IT', 'industry': 'IT Services'},
        {'symbol': 'ICICIBANK.NS', 'company': 'ICICI Bank Ltd', 'sector': 'Financial', 'industry': 'Banking'},
        {'symbol': 'HINDUNILVR.NS', 'company': 'Hindustan Unilever Ltd', 'sector': 'FMCG', 'industry': 'Consumer Goods'},
        {'symbol': 'BHARTIARTL.NS', 'company': 'Bharti Airtel Ltd', 'sector': 'Telecom', 'industry': 'Telecommunications'},
        {'symbol': 'ITC.NS', 'company': 'ITC Ltd', 'sector': 'FMCG', 'industry': 'Consumer Goods'},
        {'symbol': 'KOTAKBANK.NS', 'company': 'Kotak Mahindra Bank Ltd', 'sector': 'Financial', 'industry': 'Banking'},
        {'symbol': 'LT.NS', 'company': 'Larsen & Toubro Ltd', 'sector': 'Infrastructure', 'industry': 'Construction'},
        {'symbol': 'SBIN.NS', 'company': 'State Bank of India', 'sector': 'Financial', 'industry': 'Banking'},
        {'symbol': 'AXISBANK.NS', 'company': 'Axis Bank Ltd', 'sector': 'Financial', 'industry': 'Banking'},
        {'symbol': 'ASIANPAINT.NS', 'company': 'Asian Paints Ltd', 'sector': 'Consumer Durables', 'industry': 'Paints'},
        {'symbol': 'MARUTI.NS', 'company': 'Maruti Suzuki India Ltd', 'sector': 'Automobile', 'industry': 'Automobiles'},
        {'symbol': 'TITAN.NS', 'company': 'Titan Company Ltd', 'sector': 'Consumer Durables', 'industry': 'Jewelry'},
        {'symbol': 'WIPRO.NS', 'company': 'Wipro Ltd', 'sector': 'IT', 'industry': 'IT Services'},
        {'symbol': 'HCLTECH.NS', 'company': 'HCL Technologies Ltd', 'sector': 'IT', 'industry': 'IT Services'},
        {'symbol': 'ULTRACEMCO.NS', 'company': 'UltraTech Cement Ltd', 'sector': 'Cement', 'industry': 'Cement'},
        {'symbol': 'SUNPHARMA.NS', 'company': 'Sun Pharmaceutical Industries Ltd', 'sector': 'Pharma', 'industry': 'Pharmaceuticals'},
        {'symbol': 'BAJFINANCE.NS', 'company': 'Bajaj Finance Ltd', 'sector': 'Financial', 'industry': 'NBFC'},
        {'symbol': 'NESTLEIND.NS', 'company': 'Nestle India Ltd', 'sector': 'FMCG', 'industry': 'Food Products'},
        {'symbol': 'TATAMOTORS.NS', 'company': 'Tata Motors Ltd', 'sector': 'Automobile', 'industry': 'Automobiles'},
        {'symbol': 'TATASTEEL.NS', 'company': 'Tata Steel Ltd', 'sector': 'Metals', 'industry': 'Steel'},
        {'symbol': 'ADANIPORTS.NS', 'company': 'Adani Ports and SEZ Ltd', 'sector': 'Infrastructure', 'industry': 'Ports'},
        {'symbol': 'ONGC.NS', 'company': 'Oil and Natural Gas Corporation Ltd', 'sector': 'Energy', 'industry': 'Oil & Gas'},
